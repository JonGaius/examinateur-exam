...
export const paysOptions = [
    ...
    {
        label: "Île Mineures Éloignées des États-Unis",
    ...
    {
        label: "Île Turks et Caïques",
        value: "Île Turks et Caïques",
    },
    {
        label: "Île Vierges britanniques",
        value: "Île Vierges britanniques",
    },
    {
        label: "Île Vierges des États-Unis",
